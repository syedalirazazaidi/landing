      ...
      <div className="mx-auto flex max-w-6xl flex-col gap-10 md:flex-row md:items-start md:justify-between">
        ...
        <div className="max-w-sm space-y-4">
          ...
          <p className="text-sm leading-relaxed text-white/80">
            We deliver smart financial tools to help businesses grow and succeed
            effortlessly.
          </p>
        </div>
        ...
        <div className="flex items-start justify-start gap-3 md:justify-end">
          {["instagram", "x", "youtube"].map((name) => (
            <button
              key={name}
              className="flex h-11 w-11 items-center justify-center rounded-2xl bg-white text-[#385090] shadow-sm"
            >
